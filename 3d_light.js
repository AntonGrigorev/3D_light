		...
		if(clk == 0){
			...
			for (let el of indexes){
					...
					if(el.length == 3){
						...
						points.push({x: vertexes[el[1] - 2][0] * 100+ 200, y: vertexes[el[1] - 2][1] * 100+ 200});
						points.push({x: vertexes[el[2] - 2][0] * 100+ 200, y: vertexes[el[2] - 2][1] * 100+ 200});
						points.push({x: vertexes[el[3] - 2][0]* 100+ 200, y: vertexes[el[3] - 2][1] * 100+ 200});
						points.push({x: vertexes[el[0] - 2][0]* 100+ 200, y: vertexes[el[0] - 2][1] * 100+ 200});
					}
					...
					if(el.length == 3){
						...
						D = {x:vertexes[el[3] - 2][0] * 100+ 200,
							y:vertexes[el[3] - 2][1] * 100+ 200,
							z:vertexes[el[3] - 2][2] * 100+ 200};
					}
					color3dPlane(light, A, B, C, D, points);
			} 
});
				
function color3dPlane(light, A, B, C, D,points){
	var I_ph = 20;
	var I_p = 200;
	var K_p = 0.5;
	var center;
